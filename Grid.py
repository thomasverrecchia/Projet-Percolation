__author__ = 'Gastaldi & Verrecchia'
__Filename__ = 'Grid'
...
class Grid(object):
    ...
    def hull_probability(self, hull):
        ...
        for cell in hull:
            prob_t += self.p_max - ((cell[0] * delta_p) + (delta_p / 2) - (delta_p * cell[2]))
        prob = prob_t / len(hull)
        return prob

    def displayGrid(self: 'Grid', hull=None, save=False, nomsave=None) -> None:
        """
